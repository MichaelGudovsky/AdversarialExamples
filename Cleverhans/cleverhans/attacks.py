...
class FastGradientMethod(Attack):#FGSM
...
class BasicIterativeMethod(Attack):#IGSM
...
class MomentumIterativeMethod(Attack):#[42]
...
class SaliencyMapMethod(Attack):#JSMA
...
class CarliniWagnerL2(Attack):#CW
    """
...
class DeepFool(Attack):#DeepFool
